...
<body>
     ...
     <div id="mySidenav" class="sidenav">
       ...
       <!--*********************** rezervy PAGE *************************-->
       <section id="rezervy" class="sekce">
        <div class="container">
            <div class="fringe"></div>
            <div class="main">
                <!-- logo -->
                ...
                <h2 class="h2_rez aniHeader">Tvorba rezerv</h2>
                ...
                <div class="row_from_tablet tb_pc_reverse_row pad_bot">
                    ...
                    <div class="sekce_from_tablet_half">
                        <div class="hypo_img_1 aniHeroImg">
                            <img src="img/rezervy1.jpg" alt="počítání peněz" >
                        </div>
                    </div>
                    <!-- right part -->
                    <div class="sekce_from_tablet_half aligncont_sp_around">
                        <!-- <div class="aligncont_sp_around"> -->
                            <p class="part2_text aniHypoList">
                                Než se pustíte do konkrétních spořících nebo investičních nástrojů, 
                                nadefinujte si tři základní pilíře a rozprostřete své rezervy tak, 
                                abyste znali jejich faktický účel.
                            </p>
                        <!-- </div> -->
                    </div>
                </div>
                 ...
                 <!-- 1* ****************** -->
                 <div class="row_from_tablet box_7rad aniOtazka1">
                    <div class="sekce_from_tablet_half bg_pink kroky4_header_box bg_rada bg_rada1">
                        <h3><span class="kroky4">KRÁTKODOBÁ (OPERATIVNÍ) <br>REZERVA</span></h3>
                    </div>
                    <!-- right part -->
                ...
                <!-- 2******************* -->
                <div class="row_from_tablet box_7rad aniOtazka2">
                    <div class="sekce_from_tablet_half bg_darkgreen kroky4_header_box bg_rada bg_rada2">
                        <h3 class="white"><span class="kroky4">STŘEDNĚDOBÁ REZERVA</span></h3>
                    </div>
                    <!-- right part -->
                    <div class="kroky4_text_box_cont">
                        <div class=" kroky4_text_box bg_white">
                ...
                <!-- 3******************* -->
                <div class="row_from_tablet box_7rad aniOtazka3">
                    <div class="sekce_from_tablet_half bg_lightgreen kroky4_header_box bg_rada bg_rada3">
                        <h3><span class="kroky4">DLOUHODOBÁ REZERVA</span></h3>
                    </div>
                    <!-- right part -->
                    <div class="kroky4_text_box_cont">
                        <div class=" kroky4_text_box bg_white">
