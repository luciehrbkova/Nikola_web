...
<body>
    ...
    <section class="cookies" id="cookies">
        <div class="container">
            ...
            <br><br>
            <p>Existují dočasné cookies a trvalé cookies. Dočasné jsou uloženy ve vašem počítači jen do ukončení prohlížeče. Dočasné cookies umožňují uchovávání informací při přecházení z jedné webové stránky na druhou a odstraňují potřebu opakovaného zadávání některých údajů. Trvalé cookies pomáhají identifikovat váš počítač, jestliže znovu navštívíte náš web, ale neumožňují jakkoliv identifikovat vás osobně. Trvalé cookies umožňují přizpůsobovat naše stránky vašim zájmům, ale nemůžeme jakkoliv identifikovat vás osobně a příslušná data ukládáme zcela anonymizovaně a nespojujeme je s jakýmikoliv jinými daty..Cookies nevyužíváme k jiným než čistě technickým účelům, nespojujeme údaje získané díky nim s jakýmikoliv jinými údaji a pracujeme s cookies tak, že neumožňují identifikovat konkrétní osoby.</p>
            <br><br><br><br>
            </div>
            <div class="fringe"></div>
            <!-- menu -->
